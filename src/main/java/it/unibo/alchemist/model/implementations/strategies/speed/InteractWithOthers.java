...
public class InteractWithOthers<T> implements SpeedSelectionStrategy<T> {
	 ...
	 *            the number obtained
	 */
	public InteractWithOthers(final IMapEnvironment<T> environment, final INode<T> n, final IReaction<T> reaction,
			final IMolecule inter, final double speed, final double radius, final double interaction) {
