...
public class ReadBuffer {
	 ...
	 */
	public static final int MAXIMUM_BUFFER_SIZE = 2500000;

	private byte[] bufferData;
	private int bufferPosition;
	private final RandomAccessFile inputFile;

	public ReadBuffer(final RandomAccessFile inputFile) {
	 ...
	 */
	public boolean readFromFile(final int length) throws IOException {
	 ...
	 * @return the UTF-8 decoded string (may be null).
	 */
	public String readUTF8EncodedString(final int stringLength) {
