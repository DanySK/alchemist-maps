...
Adds maps support for [Alchemist][Alchemist]. Allows for navigating nodes along streets relying on [Graphhopper](https://graphhopper.com/), for navigating using GPS traces, and for displaying maps in Swing user interfaces. For more information on Alchemist, users are invited to refer to the [Alchemist main project][alchemist-git].

## Build Status
[![Build Status](https://drone.io/github.com/DanySK/alchemist-maps/status.png)](https://drone.io/github.com/DanySK/alchemist-maps/latest)
...
* Clone URI -> Next
* Paste `git@github.com:DanySK/alchemist-maps.git` as URI -> Next -> Next
...
[Javadoc]: http://137.204.107.70/alchemist-build/alchemist-maps/build/docs/javadoc/
[Jars]: https://drone.io/github.com/DanySK/alchemist-maps/files
[reports]: https://drone.io/github.com/DanySK/alchemist-maps/files/build/reports/reports.tar
[dashboard]: http://137.204.107.70/alchemist-build/alchemist-maps/build/reports/buildDashboard/
[test]: http://137.204.107.70/alchemist-build/alchemist-maps/build/reports/tests/
[checkstyle]: http://137.204.107.70/alchemist-build/alchemist-maps/build/reports/checkstyle/main.html
[checkstyle-test]: http://137.204.107.70/alchemist-build/alchemist-maps/build/reports/checkstyle/test.html
[findbugs]: http://137.204.107.70/alchemist-build/alchemist-maps/build/reports/findbugs/main.html
[findbugs-test]: http://137.204.107.70/alchemist-build/alchemist-maps/build/reports/findbugs/test.html
[pmd]: http://137.204.107.70/alchemist-build/alchemist-maps/build/reports/pmd/main.html
[pmd-test]: http://137.204.107.70/alchemist-build/alchemist-maps/build/reports/pmd/test.html
